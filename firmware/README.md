...
- **0.5.0-spike (2026-09-26):** Seans heartbeat'i `relayIndex` tasir (device twin, ADR-0006). `reason: DRIFT` STOP'u diger STOP'lar gibi yalnizca `sessionId` eslesirse uygulanir.
